{ pkgs, ... }:
{
  ...
  environment.etc."brave/native-messaging-hosts/com.ugetdm.chrome.json".source =
  ...
  environment.etc."chromium/native-messaging-hosts/com.ugetdm.chrome.json".source =
    "${pkgs.uget-integrator}/etc/chromium/native-messaging-hosts/com.ugetdm.chrome.json";
}
